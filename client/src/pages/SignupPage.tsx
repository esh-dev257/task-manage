  ...
  return (
    <div className="min-h-screen flex overflow-hidden" style={{ background: "#f0f0f0" }}>
      ...
      <div className="hidden lg:flex w-[46%] relative overflow-hidden flex-col justify-between p-14"
        ...
        <div className="absolute bottom-36 left-14 w-12 h-12 rounded-full" style={{ background: "#C8FF00", opacity: 0.35 }} />
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[{ num: "10k+", label: "Teams" }, { num: "50k+", label: "Tasks done" }, { num: "99.9%", label: "Uptime" }, { num: "Free", label: "To start" }].map(s => (
              <div key={s.label} className="rounded-2xl p-4 text-center" style={{ background: "rgba(255,255,255,0.1)", border: "2px solid rgba(255,255,255,0.18)" }}>
                <p className="text-white font-black text-xl">{s.num}</p>
                <p className="text-[11px] mt-0.5" style={{ color: "#C8FF00" }}>{s.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative z-10 rounded-2xl px-5 py-4" style={{ background: "rgba(255,255,255,0.1)", border: "2px solid rgba(255,255,255,0.2)" }}>
          ...
          <p className="text-[11px] mt-2 font-bold" style={{ color: "#C8FF00" }}>-Engineering Lead, TechCo</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-black" style={{ color: "#0a0a0a" }}>Create Account</h2>
            <p className="text-sm mt-1.5" style={{ color: "#666666" }}>
              Already have an account?{" "}
              <Link to="/login" className="font-black transition-opacity hover:opacity-70" style={{ color: "#1A3BFF" }}>
                Sign in
              </Link>
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs font-bold" style={{ color: "#888888" }}>create with email</span>
            <div className="flex-1 h-px" style={{ background: "#0a0a0a", opacity: 0.15 }} />
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-black mb-2 uppercase tracking-wide" style={{ color: "#0a0a0a" }}>Full Name</label>
              <div className="relative">
                <User size={15} className="absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: "#888888" }} />
              ...
              {errors.name && <p className="text-xs text-red-500 mt-1.5 pl-1">{errors.name}</p>}
            </div>
            ...
            <div>
              <label className="block text-xs font-black mb-2 uppercase tracking-wide" style={{ color: "#0a0a0a" }}>Password</label>
              <div className="relative">
          ...
          <p className="text-center text-xs mt-7" style={{ color: "#888888" }}>
            By signing up you agree to our{" "}
            <span className="font-black cursor-pointer" style={{ color: "#1A3BFF" }}>Terms of Service</span>
          </p>
        </div>
      </div>
    </div>
