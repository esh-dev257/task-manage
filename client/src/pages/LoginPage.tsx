      ...
      <div className="hidden lg:flex w-[44%] relative overflow-hidden flex-col justify-between p-12"
        ...
        <div>
          ...
          <p className="text-base leading-relaxed mb-10" style={{ color: "#64748B" }}>
            Manage projects, track tasks,<br />and collaborate with your team.
          </p>
        ...
        <div className="rounded-xl px-4 py-4" style={{ background: "#1E293B", border: "1px solid #334155" }}>
          ...
          <p className="text-sm italic" style={{ color: "#CBD5E1" }}>"The best task manager our team has ever used."</p>
          <p className="text-xs mt-2 font-medium" style={{ color: "#475569" }}>— Product Team, Startup Inc.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-[360px]">
          ...
          <div className="mb-7">
            ...
            <p className="text-sm mt-1" style={{ color: "#64748B" }}>Enter your credentials to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-xs cursor-pointer transition-colors hover:text-blue-600" style={{ color: "#94A3B8" }}>Forgot?</span>
              </div>
              <div className="relative">
            ...
            <label className="flex items-center gap-2 cursor-pointer select-none">
              <input type="checkbox" className="w-3.5 h-3.5 rounded" style={{ accentColor: "#2563EB" }} />
          ...
          <p className="text-center text-sm mt-6" style={{ color: "#64748B" }}>
            ...
            <Link to="/signup" className="font-semibold transition-colors hover:opacity-70" style={{ color: "#2563EB" }}>
              Sign up
            </Link>
          </p>
        </div>
